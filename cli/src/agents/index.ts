...
export interface AgentResult {
  pass: boolean; // true = no violations, false = violations found
  findings: string; // Markdown-formatted findings
}
 ...
 */
export async function runAgent(agentId: string): Promise<AgentResult> {
