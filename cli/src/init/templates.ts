import type { StackInfo, Metric, PolishConfig } from '../types.js';

/**
 * Generate a Polish config from detected stack
 */
export function generateConfig(stack: StackInfo): PolishConfig {
 ...
 */
function toolToMetric(
  tool: { category: string; name: string; command?: string },
  stack: StackInfo
): Metric | null {
 ...
 */
function getDefaultCommand(toolName: string, stack: StackInfo): string | null {
 ...
 */
function getDefaultMetrics(stack: StackInfo): Metric[] {
