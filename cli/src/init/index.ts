...
import type { PolishConfig, Metric, StackInfo } from '../types.js';

export interface InitOptions {
  force?: boolean;
  dryRun?: boolean;
  yes?: boolean; // Skip interactive prompts, use detected defaults
}
...
export async function initCommand(options: InitOptions = {}): Promise<void> {
  ...
  const metrics: Metric[] = selectedNames.map((name) => {
