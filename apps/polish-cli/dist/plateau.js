 ...
 */
export function detectPlateau(state, currentScore, target, mode = 'stalled') {
 ...
 */
function detectPlateauStalled(state) {
 ...
 */
export function buildPlateauContext(state, currentScore, target) {
