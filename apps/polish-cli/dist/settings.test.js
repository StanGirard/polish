...
import { getSettingsDir, getSettingsPath, isInitialized, loadSettings, saveSettings, getApiKey, getBaseUrl, getModel, } from './settings.js';
...
describe('getBaseUrl', () => {
    ...
    test('returns base URL from settings', () => {
        ...
        writeFileSync(settingsPath, JSON.stringify({ anthropic: { apiKey: 'key', baseUrl: 'https://custom.anthropic' } }));
...
describe('getModel', () => {
    ...
    test('returns model from provider-specific settings', () => {
        ...
        writeFileSync(settingsPath, JSON.stringify({ anthropic: { apiKey: 'key', model: 'claude-opus-4' } }));
