 ...
 */
function parseMetricOutput(metric: Metric, output: string, exitCode: number): number {
 ...
 */
function parseTestOutput(output: string, exitCode: number): number {
 ...
 */
function parseTypeScriptOutput(output: string, exitCode: number): number {
 ...
 * Parse ESLint output
 */
function parseLintOutput(output: string, exitCode: number): number {
  if (exitCode === 0) return 100;
 ...
 */
function parseDuplicationOutput(output: string, exitCode: number): number {
 ...
 */
export function findWorstMetric(score: ScoreResult): MetricResult {
